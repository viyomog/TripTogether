...
const SignupPage = () => {
  ...
  return (
    <AuthLayout
      subtitle="Plan tours with your explorer"
      ...
      >
        <motion.div variants={itemVariants}>
          <div className="input-group-rose">
            <label className="label-rose" htmlFor="signup-name">
              Full Name
            </label>
        ...
        <motion.div variants={itemVariants}>
          <div className="input-group-rose">
            <label className="label-rose" htmlFor="signup-email">
              Email
            </label>
            <div className="input-container-rose">
        ...
        <motion.div variants={itemVariants}>
          <div className="input-group-rose">
            <label className="label-rose" htmlFor="signup-password">
              Password
            </label>
            <div className="input-container-rose">
